        ...
        if(len(self.buffer) >= PACKET_LENGTH):
            ...
            if crc_check(data_string):
                ...
                if ((PACKET_ID == '0') and (DATA == "ACK")):
                    ...
                    connection_threads[self.connection_index].ACK = True
                elif ((PACKET_ID == '2') and (DATA == "START")):
                    print(CR, "Data collection started ", datetime.now())
                elif ((PACKET_ID == '2') and (DATA == "END")):
                    print(CR, "Data collection ended ", datetime.now())
                    connection_threads[self.connection_index].endFlag = True
